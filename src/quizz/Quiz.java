// Main author: Dawid Jabuwoski - GUI, core quizz features (getting and interpreting the user's answer and checking it, displaying and moving through the questions etc...), difficulty management
// Secondary author: Victor Pottier - Linking work realised on login, account management, stats (Points score calculation, leaderboards, average points score, points score standard deviation and the related GUI elements) 
